...
const validationError = (res: Response, field: string, message: string, details?: any) => {
...
export const validateFields = (schema: Record<string, ValidatorFunction>, source: 'body' | 'params' | 'query' = 'body') => {
...
type ValidatorFunction = (value: any, fieldName: string, allValues?: any) => true | string;
...
export const validators = {
  ...
  minLength: (min: number) => (value: any, fieldName: string): true | string => {
  ...
  maxLength: (max: number) => (value: any, fieldName: string): true | string => {
  ...
  min: (min: number) => (value: any, fieldName: string): true | string => {
  ...
  max: (max: number) => (value: any, fieldName: string): true | string => {
  ...
  oneOf: (options: any[]) => (value: any, fieldName: string): true | string => {
  ...
  match: (matchField: string, errorMessage?: string) => 
    (value: any, fieldName: string, allValues: any): true | string => {
      if (value !== undefined && value !== null && value !== allValues[matchField]) {
  ...
  compose: (...validators: ValidatorFunction[]) => 
    (value: any, fieldName: string, allValues: any): true | string => {
