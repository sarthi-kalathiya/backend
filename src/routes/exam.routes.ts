...
router.post('/exams', authenticateTeacher, validateFields(createExamSchema), examController.createExam);
router.get('/exams/:examId', authenticateTeacher, examController.getExamById);
router.put('/exams/:examId', authenticateTeacher, validateFields(updateExamSchema), examController.updateExam);
router.patch('/exams/:examId/status', authenticateTeacher, validateFields(updateExamStatusSchema), examController.updateExamStatus);
...
router.post('/exams/:examId/question', authenticateTeacher, validateFields(questionSchema), examController.addQuestion);
router.post('/exams/:examId/questions', authenticateTeacher, examController.addBulkQuestions);
router.put('/exams/:examId/questions/:questionId', authenticateTeacher, validateFields(questionSchema), examController.updateQuestion);
